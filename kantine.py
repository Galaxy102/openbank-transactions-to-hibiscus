...
from kantine import KantineTransactionLoader


if __name__ == '__main__':
    # Frage Dateinamen zum Kontoauszug im "Website, complete"-Format ab
    in_file_name = input("Pfad zum Kontoauszug: ")
    # in_file_name = "/home/galaxy/Downloads/output.csv"
    out_file_name = in_file_name + ".csv"

    data_frame = KantineTransactionLoader.load_transactions_from_csv(file_name=in_file_name)
